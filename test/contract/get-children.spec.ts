...
test('should get nothing if no children', (test) => {
...
test('should get the paths of a one child container', (test) => {
...
test('should get the paths of two contracts with different slugs', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should get the paths of two contracts with same slugs', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should be able to filter by one type', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should be able to filter by two types', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.blob'].nodejs['4.8.0'].object)
...
test('should ignore unknown types', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.blob'].nodejs['4.8.0'].object)
	const container = new Contract({
		type: 'foo',
...
test('should return an empty array if no type matches', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.blob'].nodejs['4.8.0'].object)
	const container = new Contract({
		type: 'foo',
...
test('should not return the same contract multiple times if it contains aliases', (test) => {
...
test('should return nested children', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.blob'].nodejs['4.8.0'].object)
...
test('should return two level nested children', (test) => {
...
test('should return nested children that match the desired type', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.blob'].nodejs['4.8.0'].object)
	contract1.addChild(contract2)
