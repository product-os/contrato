...
test('should build missing templates', (test) => {
...
test('should not rehash the contract if the rehash option is set to false', (test) => {
	const contract = new Contract({
		name: 'Debian {{this.data.codename}}',
		slug: 'debian',
		version: 'wheezy',
...
test('should return the contract instance', (test) => {
	const contract = new Contract({
		name: 'Debian {{this.data.codename}}',
		slug: 'debian',
		version: 'wheezy',
...
test('should not perform interpolation on children', (test) => {
	const contract = new Contract({
		slug: 'debian',
		version: 'wheezy',
		type: 'sw.os',
