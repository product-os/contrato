...
test('should add a contract to a contract without children', (test) => {
...
test('should add two contracts of different types', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should not add a contract twice', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const container = new Contract({
		type: 'foo',
		slug: 'bar'
...
test('should two contracts of same type but different slugs', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should add a new version of an existing contract', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should add two new versions of an existing contract', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.os'].debian.jessie.object)
...
test('should re-hash the parent contract', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const container = new Contract({
		type: 'foo',
		slug: 'bar'
...
test('should not re-hash the parent contract if the rehash option is false', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const container = new Contract({
		type: 'foo',
		slug: 'bar'
