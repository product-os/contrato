...
test('should delete a contract from a set of contracts', (test) => {
...
test('should ignore contracts that are not in the set', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.os'].debian.jessie.object)
	const contract3 = new Contract(CONTRACTS['sw.os'].fedora['25'].object)
...
test('should remove a slug object if it becomes empty after the removal', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should correctly handle number versions', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should ignore an invalid version of an existing contract', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.os'].debian.jessie.object)
...
test('should take versions into account before removing a contract from the slug object', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.os'].fedora['24'].object)
	const contract3 = new Contract(CONTRACTS['sw.os'].fedora['25'].object)
...
test('should take versions into account before removing a contract from the type object', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.os'].debian.jessie.object)
...
test('should remove a type object if it becomes empty after the removal', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should return the object instance', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.os'].debian.jessie.object)
	const contract3 = new Contract(CONTRACTS['sw.os'].fedora['25'].object)
...
test('should return the object instance even if the type does not exist', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
	const contract2 = new Contract(CONTRACTS['sw.os'].debian.jessie.object)
...
test('should remove a contract with aliases', (test) => {
...
test('should remove a contract with aliases when there is another aliased contract of the same type', (test) => {
...
test('should remove a contract with aliases when there are two aliased contracts of the same type', (test) => {
	const contract1 = new Contract({
		type: 'hw.device-type',
		name: 'Intel NUC',
		slug: 'intel-nuc',
...
test('should re-hash the universe', (test) => {
	...
	test.is(container.metadata.hash, hashObject(container.raw))
})
