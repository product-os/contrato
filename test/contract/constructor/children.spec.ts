...
test('should take a contract with a single child', (test) => {
...
test('should take a contract with two children of the same type', (test) => {
	const contract = new Contract({
		type: 'misc.collection',
		slug: 'my-collection',
		children: {
...
test('should take a contract with two children of the same type and slug', (test) => {
	const contract = new Contract({
		type: 'misc.collection',
		slug: 'my-collection',
		children: {
...
test('should take a contract with two children of different types', (test) => {
	const contract = new Contract({
		type: 'misc.collection',
		slug: 'my-collection',
		children: {
