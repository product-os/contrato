...
test('should build a tree with one children', (test) => {
	...
	test.deepEqual(build(container), {
		sw: {
			os: contract1.raw
		}
	})
...
test('should build a tree with two contracts of different types', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should build a tree with two contracts of the same type', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should build a tree with two versions of the same slug', (test) => {
	const contract1 = new Contract(CONTRACTS['sw.os'].debian.wheezy.object)
...
test('should create a tree of two variants of the same contract', (test) => {
